...
const NewsletterForm = ({ isDarkMode }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(
          errorData.message || "Oops! Something went wrong. Try again! 😅"
        );
      }
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <h2
        style={{ fontSize: "32px", marginBottom: "15px", fontWeight: "bold" }}
      >
        Stay in the Loop! 📬
      </h2>
      <p style={{ fontSize: "16px", marginBottom: "30px", opacity: 0.95 }}>
        Get productivity tips, funny task ideas, and exclusive updates delivered
        to your inbox. No spam, just good vibes! ✨
      </p>
